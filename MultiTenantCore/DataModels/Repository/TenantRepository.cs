...
namespace MultiTenantCore.DataModels.Repository
{
    public class TenantRepository : ITenantRepository
    {
        ...
        public string onTenantEntry(Tenant connection_name)
        {
            ...
            var connectionString = $"server=localhost;Port=5432;User Id=alex;password=alex;DataBase=MultiTenantCore{connection_name.SubDomainName};Integrated Security=true;";
